...
namespace WiFiMapCore.Model.Network.ManagedWiFi
{
    ...
    public static class Wlan
    {
        ...
        public struct WlanConnectionParameters
        {
	        ...
	        /// <summary>
	        ///     Pointer to a <c>Dot11BssidList</c> structure that contains the list of basic service set (BSS) identifiers desired
	        ///     for the connection.
	        /// </summary>
	        /// <remarks>
        ...
        public struct WlanRadioState
        {
            ...
            private readonly WlanPhyRadioState[] phyRadioState;
