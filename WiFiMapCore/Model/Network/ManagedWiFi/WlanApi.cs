    ...
    public class WlanClient : IDisposable
    {
        ...
        public WlanInterface[] Interfaces
        {
            get
            {
                ...
                {
                    var header =
                        (Wlan.WlanInterfaceInfoListHeader) Marshal.PtrToStructure(ifaceList,
                    ...
                    {
                        var info =
                            (Wlan.WlanInterfaceInfo) Marshal.PtrToStructure(new IntPtr(listIterator),
        ...
        public string GetStringForReasonCode(Wlan.WlanReasonCode reasonCode)
        {
            var
                sb = new StringBuilder(
                    1024); // the 1024 size here is arbitrary; the WlanReasonCodeToString docs fail to specify a recommended size
            Wlan.ThrowIfError(
        ...
        public class WlanInterface
        {
            ...
            public Wlan.WlanRadioState RadioState
            {
                get
                {
                    ...
                    Wlan.ThrowIfError(
                        Wlan.WlanQueryInterface(client.clientHandle, info.interfaceGuid, Wlan.WlanIntfOpcode.RadioState,
                            IntPtr.Zero, out valueSize, out valuePtr, out opcodeValueType));
                    try
                    {
            ...
            public Wlan.WlanConnectionAttributes CurrentConnection
            {
                get
                {
                    ...
                    try
                    {
                        return (Wlan.WlanConnectionAttributes) Marshal.PtrToStructure(valuePtr,
            ...
            public NetworkInterface NetworkInterface
            {
                get
                {
                    ...
                    foreach (var netIface in NetworkInterface.GetAllNetworkInterfaces())
                    {
                        ...
                        if (netIfaceGuid.Equals(info.interfaceGuid)) return netIface;
                    }
            ...
            private static Wlan.WlanAvailableNetwork[] ConvertAvailableNetworkListPtr(IntPtr availNetListPtr)
            {
                ...
                {
                    availNets[i] = (Wlan.WlanAvailableNetwork) Marshal.PtrToStructure(new IntPtr(availNetListIt),
                            ...
                            while (eventQueue.Count != 0)
                            {
                                ...
                                if (e is WlanConnectionNotificationEventData)
                                {
                                    ...
                                    if (wlanConnectionData.notifyData.notificationSource ==
                                        ...
                                        switch ((Wlan.WlanNotificationCodeAcm) wlanConnectionData.notifyData
                                            .notificationCode)
                                        {
                                            case Wlan.WlanNotificationCodeAcm.ConnectionComplete:
            ...
            public Wlan.WlanProfileInfo[] GetProfiles()
            {
                ...
                try
                {
                    var header = (Wlan.WlanProfileInfoListHeader) Marshal.PtrToStructure(profileListPtr,
                    ...
                    for (var i = 0; i < header.numberOfItems; ++i)
                    {
                        var profileInfo = (Wlan.WlanProfileInfo) Marshal.PtrToStructure(new IntPtr(profileListIterator),
